...
A collection of SQL projects showcasing database design, query writing, and data analysis skills across different domains and datasets.

Each project lives in its own folder and includes database schema, queries, sample data, and documentation.
